# ICS 143 Spring 2015 - Programming Assignment (100 points)
...
2.  Download and install [Ubuntu 12.04.5 LTS](http://releases.ubuntu.com/12.04/ubuntu-12.04.5-desktop-amd64.iso) inside VirtualBox.
a.  If you have resolution problems, follow the instructions [here](http://askubuntu.com/questions/73589/higher-screen-resolution-for-virtualbox).
...
4.  Open up a terminal, go to directory where 4521254.zip is and type
```sh
sh grade.sh 4521254
```
